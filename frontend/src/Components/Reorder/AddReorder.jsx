...
function AddReorder() {
  ...
  const sendRequest = async () => {
    await axios.post("http://localhost:5000/reorders/add", {
          ...
          <form className="col-span-8 p-8  mt-4 rounded-md shadow-3xl border border-blue-700 border-blur-3xl" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="border border-black p-2 w-full rounded-xl"
              />
              {errors.reorderQuantity && <span className="text-red-500">{errors.reorderQuantity}</span>}
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="border border-black p-2 w-full rounded-xl"
              />
              {errors.supplierNo && <span className="text-red-500">{errors.supplierNo}</span>}
            </div>
